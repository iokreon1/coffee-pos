CREATE TABLE payments (
    ...
    midtrans_order_id VARCHAR(100) NULL DEFAULT NULL,
    midtrans_token VARCHAR(500) NULL DEFAULT NULL,
    midtrans_url VARCHAR(500) NULL DEFAULT NULL,
    raw_notification JSON NULL DEFAULT NULL,
